    ...
    <body>
        ...
        <div class="page-main">
            <div class="page-bread-crumbs">
                ...
                <span class="text"> คอร์สเรียน อุดมศึกษา </span>
            </div>

            <div class="know-main">
                <div class="know-title">
                    <span class="text"> คอร์สเรียน อุดมศึกษา </span><br>
                ...
                <div class="know-fillter">
                    <div class="know-fillter-item col-md-2">
                        ...
                        <select class="know-select" name="grade-select">
                            ...
                            <option value="1"> ปี 2 </option>
                            <option value="1"> ปี 3 </option>
                            <option value="1"> ปี 4 </option>
                        </select>
                    </div>
