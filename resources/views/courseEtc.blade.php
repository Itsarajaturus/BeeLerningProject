    ...
    <body>
        ...
        <div class="page-main">
            <div class="page-bread-crumbs">
                ...
                <span class="text"> คอร์สเรียน อื่นๆ </span>
            </div>

            <div class="know-main">
                <div class="know-title">
                    <span class="text"> คอร์สเรียน อื่นๆ </span><br>
                ...
                <div class="know-container">
                    ...
                    <div class="row know-item-row">
                        ...
                        <div class="know-item col-md-3">
                            <div class="know-item-box" onclick="window.open('course_information', '_parent');">
                                <div class="know-item-image">
                                    <img src="{{asset('/assets/Image/knowledge/know3-1.png')}}" alt="Lorem Ipsum" class="">
                                </div>
                                <div class="share-btn">
                                    <i class="fa fa-share-alt-square" aria-hidden="true"></i>
                                </div>
